    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 lg:px-16 xl:px-24 bg-white">
        <div className="w-full max-w-[440px]">
          ...
          {/* Header */}
          <div className="mb-10">
            <h1 className="text-[34px] font-bold text-gray-900 mb-3">Create an account</h1>
            <p className="text-[17px] text-gray-600">
              Join Estatery to find your perfect home
            </p>
          </div>
          ...
          <form className="space-y-7" onSubmit={e => { e.preventDefault(); router.push('/dashboard'); }}>
            ...
            <div className="text-center">
              <p className="text-[15px] text-gray-600">
                ...
                <Link href="/login" className="font-medium text-[#6C5DD3] hover:text-[#5B4EC2] transition-colors">
                  Login
                </Link>
              </p>
            </div>
